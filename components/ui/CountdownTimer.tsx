  ...
  return (
    <div className="grid grid-cols-4 gap-2 sm:gap-4 max-w-md w-full mx-auto">
      {units.map((unit) => (
        <div
          key={unit.label}
          className="relative group flex flex-col items-center justify-center p-3 sm:p-4 rounded-xl bg-[#030917]/90 border border-cyan-500/50 hover:border-cyan-300 shadow-[0_0_15px_rgba(0,114,255,0.25)] hover:shadow-[0_0_30px_rgba(0,240,255,0.6)] transition-all duration-300 hover-vibrate interactive-react cursor-pointer overflow-hidden"
        >
