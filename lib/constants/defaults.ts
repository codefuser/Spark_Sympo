...
export const DEFAULT_EVENTS: SymposiumEvent[] = [
  {
...
export const DEFAULT_FACULTY_COORDINATORS: CoordinatorType[] = [
  {
    id: "coord-fac-1",
  ...
  },
  {
    ...
    role: "FACULTY",
    designation: "Faculty Co-Convener",
    department: "ECE",
...
export const DEFAULT_STUDENT_COORDINATORS: CoordinatorType[] = [
  {
    id: "coord-stud-1",
    name: "Sanjay V.",
    role: "STUDENT",
  ...
  },
  {
    ...
    name: "Karthik M.",
    role: "STUDENT",
    designation: "Event Operations & Help Desk Lead",
...
export const DEFAULT_SPONSORS: SponsorType[] = [
  {
    id: "spon-1",
...
export const DEFAULT_ANNOUNCEMENTS = [
  {
    ...
    content: "Online registration for Technical, Non-Technical, and Workshop tracks is officially open. Free registration for all participants!",
    priority: "HIGH",
